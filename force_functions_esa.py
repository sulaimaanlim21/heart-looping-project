...
def energy_deriv(V,C,vertex_index,cell_index):
...
def growth_factor(V,C,i):
    ...
    growth_factor=1+1/(np.cosh(ref_angle-angle))
...
def total_force_on_vertex(V,C,vertex_index):
    ...
    for cell_index in cell_list:
        ...
        force=-energy_deriv(V,C,vertex_index,cell_index)
